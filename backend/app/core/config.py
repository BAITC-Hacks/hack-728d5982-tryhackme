...
class Settings(BaseSettings):
    ...
    PROJECT_NAME: str = "hackalem_ai_project_tryhackme"
    ...
    TIMEZONE: str = "UTC+5"  # IANA timezone (e.g. "UTC", "Europe/Warsaw", "America/New_York")
    ...
    POSTGRES_DB: str = "hackalem_ai_project_tryhackme"
