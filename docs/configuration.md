...
|----------|---------|-------------|
| `PROJECT_NAME` | `hackalem_ai_project_tryhackme` | Display name for the project |
...
| `TIMEZONE` | `UTC+5` | IANA timezone (e.g. `UTC`, `Europe/Warsaw`, `America/New_York`) |
...
| `POSTGRES_DB` | `hackalem_ai_project_tryhackme` | Database name |
