...
Run with: `uv run hackalem_ai_project_tryhackme cmd my-command --name test`
...
# Or use CLI
uv run hackalem_ai_project_tryhackme db migrate -m "Add notifications table"
uv run hackalem_ai_project_tryhackme db upgrade
```
