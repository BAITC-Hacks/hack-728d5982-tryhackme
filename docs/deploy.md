...
```bash
fly launch --name hackalem_ai_project_tryhackme-backend --region waw
fly postgres create --name hackalem_ai_project_tryhackme-db
fly postgres attach hackalem_ai_project_tryhackme-db
