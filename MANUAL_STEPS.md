# Manual setup steps for hackalem_ai_project_tryhackme
...
- [ ] (Optional) Ingest seed documents: `uv run hackalem_ai_project_tryhackme rag-ingest /path/to/file.pdf --collection docs`.
